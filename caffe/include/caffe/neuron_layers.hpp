...
template <typename Dtype>
class GReLULayer : public NeuronLayer<Dtype> {
 public:

  explicit GReLULayer(const LayerParameter& param)
      : NeuronLayer<Dtype>(param) {}

  virtual inline const char* type() const { return "GReLU"; }
 ...
 protected:
  ...
  vector<Blob<Dtype>*> tables;
//  Dtype* pdfdivcdf_table;
//  Dtype* pdfdivcdf_table_g37;
//  Dtype sigma;
};
