...
data = np.load('nott_momentum.npz')
...
data = np.load('nott_santa_explore_refine.npz')
...
data = np.load('nott_santa_small_learn_rate.npz')
...
plt.title('Nott train',fontsize=12)
plt.savefig('nott_train_with_title.pdf',bbox_inches = 'tight')
...
plt.xlabel('Epochs',fontsize=12)
plt.ylabel('Negative Log-likelihood',fontsize=12)
plt.title('Nott valid',fontsize=12)
plt.savefig('nott_valid_with_title.pdf',bbox_inches = 'tight')
...
plt.xlabel('Epochs',fontsize=12)
plt.ylabel('Negative Log-likelihood',fontsize=12)
plt.title('Nott test',fontsize=12)
plt.savefig('nott_test_with_title.pdf',bbox_inches = 'tight')
