...
data = np.load('muse_momentum.npz')
...
rmsprop_history_negll[31,0] = (rmsprop_history_negll[30,0] + rmsprop_history_negll[32,0])/2.
rmsprop_history_negll[31,1] = (rmsprop_history_negll[30,1] + rmsprop_history_negll[32,1])/2.

data = np.load('muse_adam.npz')
...
data = np.load('muse_santa_explore_refine.npz')
...
data = np.load('muse_santa_small_learn_rate.npz')
...
plt.title('Muse train',fontsize=12)
plt.savefig('muse_train_with_title.pdf',bbox_inches = 'tight')
...
plt.xlabel('Epochs',fontsize=12)
plt.ylabel('Negative Log-likelihood',fontsize=12)
plt.title('Muse valid',fontsize=12)
plt.savefig('muse_valid_with_title.pdf',bbox_inches = 'tight')
...
plt.xlabel('Epochs',fontsize=12)
plt.ylabel('Negative Log-likelihood',fontsize=12)
plt.title('Muse test',fontsize=12)
plt.savefig('muse_test_with_title.pdf',bbox_inches = 'tight')
