...
data = np.load('jsb_santa_explore_refine_2.npz')
...
data = np.load('jsb_santa_explore_refine.npz')
...
plt.title('JSB train',fontsize=12)
plt.savefig('jsb_train_with_title.pdf',bbox_inches = 'tight')
...
plt.xlabel('Epochs',fontsize=12)
plt.ylabel('Negative Log-likelihood',fontsize=12)
plt.title('JSB valid',fontsize=12)
plt.savefig('jsb_valid_with_title.pdf',bbox_inches = 'tight')
...
plt.xlabel('Epochs',fontsize=12)
plt.ylabel('Negative Log-likelihood',fontsize=12)
plt.title('JSB test',fontsize=12)
plt.savefig('jsb_test_with_title.pdf',bbox_inches = 'tight')
