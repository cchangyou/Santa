        ...
        function [errs acc]= trainEpoch(obj, model, data, testdata)
            ...
            while dataChunk.size > 0
                ...
                for lo = 1:obj.descentOpts.batchSize:dataChunk.size
                    ...
                    if obj.descentOpts.iter > obj.descentOpts.burnin  && mod(obj.descentOpts.iter, 10)== 0
                        if strcmp(obj.name,'SGLD') || strcmp(obj.name,'Santa'); 
                            ...
                            obj.ave_preds = preds;                            
                        elseif strcmp(obj.name,'RMSprop')|| strcmp(obj.name,'SGD') || strcmp(obj.name,'ADAM') || strcmp(obj.name,'SGD\_Moment')
